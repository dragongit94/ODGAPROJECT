...
<body>
                           ...
                           <nav>
                              <ul id="navigation">
                                 ...
                                 <li><a href="use.do">이용방법</a></li>
                               			<c:if test="${!empty LOGINUSER.m_id}">
		                                 <li class="add-list"><a href="planner?m_id=${LOGINUSER.m_id}"><i class="ti-plus"></i>나의 여행 만들기</a></li>
		                                </c:if>
		                                <c:if test="${empty LOGINUSER.m_id}">
		                                 <li class="add-list"><a href="login.do"><i class="ti-plus"></i>나의 여행 만들기</a></li>
		                                </c:if>
		                                 <li class="login">
                              <c:choose>
   ...
   $.getJSON('http://api.openweathermap.org/data/2.5/forecast?id=1835848&APPID=f8b8761c25df03a84389bdbb6a97a6c5&units=metric'
      ...
      <div class="weather"><img src="http://openweathermap.org/img/w/10d.png"></br>
      <strong>현재 서울 날씨</strong></br>
