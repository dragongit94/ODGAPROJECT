                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="m_nick" value="${LOGINUSER.m_nick}"  class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="password" name="m_newpwd" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>자기소개</label>
                          <div class="form-group">
                            <label class="bmd-label-floating">철이 없었죠 코딩이 좋아 비트캠프을 갔다는 자체가.. </label>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">${LOGINUSER.m_nick}</h4>
                  <p class="card-description">
                   	철이 없었죠 코딩이 좋아 비트캠프을 갔다는 자체가..
                  </p>
