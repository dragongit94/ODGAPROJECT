				...
				<div class="listing-area pt-120 pb-120">
					...
					<div class="row" style="margin-right:5px;margin-left:5px;margin-top:10px">
						...
						<div class="col-7">
							...
							<div id="map" style="width:100%;height:90%;float:bottom;margin-right:0px;margin-top: 5%;"></div>
...
<!-- <button style="background: #fff; color:black" onclick="day.do?sp_day='+trCnt+'"> -->
<!-- href="day.do?p_id=5&sp_day='+trCnt+'" -->
<script>
